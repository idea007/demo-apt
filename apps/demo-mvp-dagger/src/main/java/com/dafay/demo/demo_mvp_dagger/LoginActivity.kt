...
import com.example.demo.mvp.di.component.DaggerActivityLoginComponent
...
class LoginActivity : BaseActivity(com.dafay.demo.lib.base.R.layout.activity_login), ILoginView {
    ...
    private fun injectDependency() {
        DaggerActivityLoginComponent.builder().activityLoginModule(ActivityLoginModule(this)).build().inject(this)
    }
